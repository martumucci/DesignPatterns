...
namespace Decorator.Decorator
{
    ...
    //  1. Don't want to rewrite or alter existing code (OCP)
    //  2. Want to keep new functionality separate (SRP)

    //  The Decorator facilitates the addition of behaviors to individual objects
